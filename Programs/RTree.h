// Notes:
// This file compiles under MSVC 6 SP5 and MSVC .Net 2003 it may not work on other compilers without modification.
// These next few lines may be win32 specific, and one may need to modify them to compile on other platforms:
#ifndef RTREE_H
#define RTREE_H
